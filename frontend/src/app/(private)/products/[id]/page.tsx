      ...
      <main className="max-w-[992px] mx-auto px-4 pt-5 mb-5 w-full h-[100vh]">
        <div className="flex flex-col justify-between h-[100%]">
          <div>
            ...
            <div className={`${bgColorIsDiet} py-4 mt-4 rounded-sm`}>
              <h2 className="text-neutral-700 text-center font-normal">
                Refeições
              </h2>
            </div>
            ...
            <div className="flex flex-col items-start gap-4 mt-10">
              <div className="flex flex-col items-start ga-2">
                ...
                <p className="text-sm font-light text-neutral-700 dark:text-neutral-200">
                  {meal?.description}
                </p>
              </div>
            ...
            <div className="flex items-center gap-2 bg-neutral-100 dark:bg-transparent dark:border-1 rounded-full px-4 py-2 max-w-max mt-5">
              <div
